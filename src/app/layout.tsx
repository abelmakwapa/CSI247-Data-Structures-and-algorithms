...
export default function RootLayout({ children }: { children: ReactNode }) {
  return <html lang="en" data-scroll-behavior="smooth"><body><RootProvider theme={{ enabled: false }}><AccessibilityEnhancements /><OfflineStatus />{children}</RootProvider></body></html>;
}
